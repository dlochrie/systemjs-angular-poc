 ...
 * @export
 */
QuotesController = function($scope) {
  /**
...
/**
 * Protect injected propterties from getting renamed.
 * @type {!Array.<string>}
 */
QuotesController.$inject = ['$scope'];
 ...
 * @export
 */
QuotesController.prototype.getNewQuote = function() {
  var current = this.scope_.quote;
  var quotes = QuotesController.NORRIS_QUOTES_;
  var length = quotes.length;
  var index = Math.floor(Math.random() * (length - 1 + 1)) + 1;
 ...
 * @export
 */
QuotesController.prototype.updateQuote = function() {
 ...
 * @private
 */
QuotesController.NORRIS_QUOTES_ = [
